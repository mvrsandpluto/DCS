package lab.scd.net.PIandPID.PID;
...
import lab.scd.net.PIandPID.PI.FirstOrderThreads;

import java.util.HashMap;
import java.util.function.Consumer;

public class FirstOrderPID {
    /*
    ...
    public FirstOrderPID() {

// specify constants and period
        long period = 10;
        FirstOrderThreads plant = new
                FirstOrderThreads(0.5, 0.7, 0.2, 0.3, period);
...
// a reference is inserted
    ...
    public static void main(String args[]) {new FirstOrderPID();}
}
